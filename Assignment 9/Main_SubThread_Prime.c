//WAP where the main thread will accept an integer as input and will create a sub-thread, which will check whether the number is prime or not and return the result ("PRIME" or "NOT PRIME") to the main thread.
